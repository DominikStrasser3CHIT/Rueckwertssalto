...
public class Colum {
	...
	/**
	 * Kennzeichnet diesen column als NOT Null able
	 */
	public void isNab() {
		this.isNab = true;
	}
	...
	/**
	 * @return gibt true zurück fals die Tabelle NOT NULL able ist
	 */
	public boolean isItNab() {
		return this.isNab;
	}
	/**
